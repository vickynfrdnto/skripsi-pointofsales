...
class ExportExcelTransaksi implements WithMultipleSheets, ShouldAutoSize, WithStyles
{
    use Exportable;
...
class TransactionSheet implements FromView, WithTitle
{
    ...
    public function view(): View
    {
        ...
        if ($check_access->kelola_laporan == 1) {
            ...
            if ($jenis_laporan == 'period') {
                ...
                $transactions = Transaction::select('kode_transaksi', 'total', 'bayar', 'kembali', 'kasir')
            ...
            return view('export.transactions', compact('transactions', 'tgl_awal', 'tgl_akhir'));
        } else {
            return back();
        }
    }

...
Route::group(['middleware' => ['auth', 'checkRole:admin,kasir,owner']], function(){
	...
	// > pelanggan
	Route::get('/pelanggan', 'PelangganController@viewPelanggan');
	Route::get('/pelanggan/new', 'PelangganController@viewNewPelanggan');
	Route::post('/pelanggan/create', 'PelangganController@createPelanggan');
	Route::get('/pelanggan/edit/{id}', 'PelangganController@editPelanggan');
	Route::post('/pelanggan/update', 'PelangganController@updatePelanggan');
	Route::get('/pelanggan/delete/{id}', 'PelangganController@deletePelanggan');
	Route::get('/pelanggan/filter/{id}', 'PelangganController@filterTable');
	// > Akses
...
Route::get('/report/barang', 'ReportManageController@reportBarang')->name('report.barang');

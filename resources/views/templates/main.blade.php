...
<html lang="en">
  <head>
    ...
    <title>TOKO SUMBER REZEKI| Reservation</title>
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
          <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}">
            <h2 class="logo1">SUMBER REZEKI</h2>
            {{-- <img src="{{ asset('icons/logo.png') }}" alt="logo" />  --}}
          </a>
          <a class="navbar-brand brand-logo-mini" href="{{ url('/dashboard') }}">
            <h3 class="logo-mini">TS</h3>
            {{-- <img src="{{ asset('icons/logo-mini.png') }}" alt="logo" />  --}}
          </a>
        </div>
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="notificationDropdown">
                ...
                @if ($cek_supply_system->status == 1)
                    @php
                        $low_stock_items = $notification->where('stok', '<', 10);
                        $empty_stock_items = $notification->where('stok', 0);
                    @endphp

                    @if ($low_stock_items->isNotEmpty())
                        <a class="dropdown-item preview-item py-3" href="/notifstok/menipis">
                    ...
                    @if ($empty_stock_items->isNotEmpty())
                        <a class="dropdown-item preview-item py-3" href="/notifstok/menipis">
                            <div class="preview-thumbnail">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="kelola_laporan">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/report/barang') }}">Laporan Barang</a>
                  </li>
                  <li class="nav-item">
        ...
        <div class="main-panel">
          ...
          <footer class="footer" id="footer-content">
            <div class="container-fluid clearfix">
              ...
              {{-- <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"><a href="https://fhahroulrozi-website.netlify.app/"> Fhahroul Rozi </a> --}}
              </span>
            </div>
          </footer>
        </div>

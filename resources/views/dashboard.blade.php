          ...
          <div class="card-body custom-card-p">
            <div class="row">
              <div class="col-12 d-flex justify-content-start align-items-center icon-card">
                ...
                <div class="ml-3">
                  <p class="m-0">Transaksi Harian</p>
                  <h5>{{ $customers_daily }} Transaksi</h5>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col-12 mb-4 d-flex justify-content-between align-items-center">
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton1">
                    ...
                    <a class="dropdown-item chart-filter" href="#" data-filter="pelanggan">Transaksi</a>
                  </div>
                </div>
              </div>
              <div class="col-12">
...
$(document).on('click', '.chart-filter', function(e){
  ...
  if(data_filter == 'pemasukan'){
    ...
    $('.btn-filter-chart').html('Transaksi');
    $('.chart-title').html('Transaksi 1 Minggu Terakhir');
  }
  $.ajax({

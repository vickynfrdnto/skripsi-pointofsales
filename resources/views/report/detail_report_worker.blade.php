      ...
      <div class="print-btn-group">
        <div class="input-group">
          <div class="input-group-prepend">
			...
			<button class="btn btn-filter-chart icon-btn" type="button" id="dropdownMenuIconButton1" data-toggle="modal" data-target="#cetakModal">
			  Export Laporan
			</button>
            {{-- <div class="dropdown">
                <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton1">
                    ...
                    <a href="/export-worker" class="btn btn-outline-success btn-sm">
			              ...
			              <div class="table-responsive">
			                <table class="table table-custom">
			                  ...
			                  <tr>
			                    ...
			                    <td><span class="ammount-box bg-green"><i class="mdi mdi-coin"></i></span>Rp. {{ number_format($transaksi->total) }}</td>
			                    <td class="text-success font-weight-bold"> Rp. {{ number_format($transaksi->bayar) }}</td>
